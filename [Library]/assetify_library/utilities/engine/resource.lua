...
resource.public.isResourceLoaded = function() return (not manager:isInternal() and resource.private.buffer[sourceResource] and resource.private.buffer[sourceResource].isLoaded and true) or false end
