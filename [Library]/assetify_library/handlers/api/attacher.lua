...
manager:exportAPI("attacher", "setAttachment", function(...)
    return attacher:attachElements(...)
end)

manager:exportAPI("attacher", "setDetachment", function(...)
    return attacher:detachElements(...)
end)

manager:exportAPI("attacher", "clearAttachment", function(...)
...
manager:exportAPI("attacher", "setBoneDetachment", function(...)
    return syncer.syncBoneDetachment(_, ...)
end)

manager:exportAPI("attacher", "setBoneRefreshment", function(...)
    return syncer.syncBoneRefreshment(_, ...)
end)

manager:exportAPI("attacher", "clearBoneAttachment", function(...)
